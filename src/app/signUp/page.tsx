...
import { SignUpFormData, signUpSchema } from "../_utils/signUpSchema";
...
export default function Page() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-black p-6 text-white">
      {/* 헤더 */}
      <header className="mb-4">순록의 편지</header>
      ...
      >
        <div className="space-y-10">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                id="userId"
                type="text"
                onChange={register("userId").onChange}
                onBlur={register("userId").onBlur}
                ref={register("userId").ref}
            ...
            {errors.userId && (
              <p className="py-1 text-red-500">{errors.userId.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.nickname && (
              <p className="py-1 text-red-500">{errors.nickname.message}</p>
            )}
          </div>
